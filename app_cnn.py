...
st.title(
    'Detection of cracks in Slabs,Roads and Images using Machine Learning and CNN'
)
...
st.write(f"Number of Negative training files: {len(negative_files)}")
...
exp_lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=7, gamma=0.1)
 ...
 # for Type change we can change it to log
#optimizer = optim.SGD(logistic_model.parameters(), lr=0.001, momentum=0.9) #try with logistic regression model
#update the learning rate from 0.001 to 0.01 date 13 April 2023
...
if st.button("Delete all files from uploads folder"):
    ...
    #create new .py for log rgress as the model needs to be separate
